...
**Response**: When it is FALSE, you do not see the output from running the code. When it is TRUE, then you can see the output.
...
**Response**: The message option returns
system information about the import.
...
**Response**: I would sort the dataset by unemployment rate, 
then observe the major at the top.
...
**Response**:Ten STEM fields graduate with a salary below $36,000. I am not
surprised Environmental Science is one of them, but I am surprised at
Neuroscience.
